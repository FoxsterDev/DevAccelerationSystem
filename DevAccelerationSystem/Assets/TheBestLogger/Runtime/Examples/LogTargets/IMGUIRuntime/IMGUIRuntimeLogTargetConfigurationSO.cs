...
{
    [CreateAssetMenu(fileName = nameof(IMGUIRuntimeLogTargetConfiguration), menuName = "ScriptableObjects/Logger/Create IMGUIRuntimeLogTargetConfiguration", order = 1)]
