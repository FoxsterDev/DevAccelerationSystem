...
{
    [DllImport("__Internal")] private static extern void CauseNullPointerCrash();
    [DllImport("__Internal")] private static extern void CauseArrayBoundsCrash();
    [DllImport("__Internal")] private static extern void CauseDivideByZeroCrash();
    [DllImport("__Internal")] private static extern void CauseUnalignedMemoryAccessCrash();
    [DllImport("__Internal")] private static extern void CauseStackOverflowCrash();
    [DllImport("__Internal")] private static extern void CauseDoubleFreeCrash();
    [DllImport("__Internal")] private static extern void CauseUseAfterFreeCrash();
    [DllImport("__Internal")] private static extern void CauseIllegalInstructionCrash();
    [DllImport("__Internal")] private static extern void CauseInvalidMemoryAccessCrash();
    [DllImport("__Internal")] private static extern void CauseUncaughtExceptionCrash();
    [DllImport("__Internal")] private static extern void CauseInvalidFunctionPointerCrash();
    [DllImport("__Internal")] private static extern void CauseBufferOverflowCrash();
    [DllImport("__Internal")] private static extern void CauseMutexCrash();
    [DllImport("__Internal")] private static extern void CauseAbortCrash();
    [DllImport("__Internal")] private static extern void CauseNullVirtualCallCrash();
    [DllImport("__Internal")] private static extern void NullReferenceNSException();
    [DllImport("__Internal")] private static extern void InvalidFileHandleException();
